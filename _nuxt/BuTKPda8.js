import{R as O,Z as P,S as I,a4 as C,a2 as B,H as h,k as c,w as S,W as v,i,U as a,V as l,f as m,g as y,n as V,X as T,Y as D,T as R,a as M,c as w,b as U,h as p,G as k,P as z,a6 as N}from"./5mLVscym.js";import{s as A}from"./Ds4LHPZM.js";import{s as E}from"./BxokLdv1.js";var L=function(s){var e=s.dt;return`
.p-message {
...
`)},K={root:function(s){var e=s.props;return["p-message p-component p-message-"+e.severity,{"p-message-outlined":e.variant==="outlined","p-message-simple":e.variant==="simple","p-message-sm":e.size==="small","p-message-lg":e.size==="large"}]},content:"p-message-content",icon:"p-message-icon",text:"p-message-text",closeButton:"p-message-close-button",closeIcon:"p-message-close-icon"},G=O.extend({name:"message",theme:L,classes:K}),H={name:"BaseMessage",extends:I,props:{severity:{type:String,default:"info"},closable:{type:Boolean,default:!1},life:{type:Number,default:null},icon:{type:String,default:void 0},closeIcon:{type:String,default:void 0},closeButtonProps:{type:null,default:null},size:{type:String,default:null},variant:{type:String,default:null}},style:G,provide:function(){return{$pcMessage:this,$parentInstance:this}}},$={name:"Message",extends:H,inheritAttrs:!1,emits:["close","life-end"],timeout:null,data:function(){return{visible:!0}},mounted:function(){var s=this;this.life&&setTimeout(function(){s.visible=!1,s.$emit("life-end")},this.life)},methods:{close:function(s){this.visible=!1,this.$emit("close",s)}},computed:{closeAriaLabel:function(){return this.$primevue.config.locale.aria?this.$primevue.config.locale.aria.close:void 0}},directives:{ripple:P},components:{TimesIcon:A}};function g(n){"@babel/helpers - typeof";return g=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(s){return typeof s}:function(s){return s&&typeof Symbol=="function"&&s.constructor===Symbol&&s!==Symbol.prototype?"symbol":typeof s},g(n)}function x(n,s){var e=Object.keys(n);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(n);s&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(n,r).enumerable})),e.push.apply(e,o)}return e}function j(n){for(var s=1;s<arguments.length;s++){var e=arguments[s]!=null?arguments[s]:{};s%2?x(Object(e),!0).forEach(function(o){W(n,o,e[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(e)):x(Object(e)).forEach(function(o){Object.defineProperty(n,o,Object.getOwnPropertyDescriptor(e,o))})}return n}function W(n,s,e){return(s=X(s))in n?Object.defineProperty(n,s,{value:e,enumerable:!0,configurable:!0,writable:!0}):n[s]=e,n}function X(n){var s=Y(n,"string");return g(s)=="symbol"?s:s+""}function Y(n,s){if(g(n)!="object"||!n)return n;var e=n[Symbol.toPrimitive];if(e!==void 0){var o=e.call(n,s);if(g(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(s==="string"?String:Number)(n)}var Z=["aria-label"];function q(n,s,e,o,r,t){var u=C("TimesIcon"),d=B("ripple");return c(),h(R,a({name:"p-message",appear:""},n.ptmi("transition")),{default:S(function(){return[v(i("div",a({class:n.cx("root"),role:"alert","aria-live":"assertive","aria-atomic":"true"},n.ptm("root")),[n.$slots.container?l(n.$slots,"container",{key:0,closeCallback:t.close}):(c(),m("div",a({key:1,class:n.cx("content")},n.ptm("content")),[l(n.$slots,"icon",{class:V(n.cx("icon"))},function(){return[(c(),h(T(n.icon?"span":null),a({class:[n.cx("icon"),n.icon]},n.ptm("icon")),null,16,["class"]))]}),n.$slots.default?(c(),m("div",a({key:0,class:n.cx("text")},n.ptm("text")),[l(n.$slots,"default")],16)):y("",!0),n.closable?v((c(),m("button",a({key:1,class:n.cx("closeButton"),"aria-label":t.closeAriaLabel,type:"button",onClick:s[0]||(s[0]=function(b){return t.close(b)})},j(j({},n.closeButtonProps),n.ptm("closeButton"))),[l(n.$slots,"closeicon",{},function(){return[n.closeIcon?(c(),m("i",a({key:0,class:[n.cx("closeIcon"),n.closeIcon]},n.ptm("closeIcon")),null,16)):(c(),h(u,a({key:1,class:[n.cx("closeIcon"),n.closeIcon]},n.ptm("closeIcon")),null,16,["class"]))]})],16,Z)),[[d]]):y("",!0)],16))],16),[[D,r.visible]])]}),_:3},16)}$.render=q;const F={class:"flex flex-col gap-2 fade-in"},J={class:"flex flex-col gap-2 mt-4 fade-in"},Q=M({__name:"Contact",setup(n){const s=w(""),e=w("");U();async function o(){var r=`mailto:${encodeURIComponent("sales@eltmnr.com")}?subject=${encodeURIComponent(s.value)}&body=${encodeURIComponent(e.value)}`;window.open(r,"_blank")}return(r,t)=>{const u=E,d=$,b=N;return c(),m("form",{onSubmit:o,class:"max-w-[48rem]"},[i("div",F,[t[2]||(t[2]=i("label",{for:"subject"},"Subject",-1)),p(u,{id:"subject",modelValue:k(s),"onUpdate:modelValue":t[0]||(t[0]=f=>z(s)?s.value=f:null),"aria-describedby":"subject-help"},null,8,["modelValue"])]),i("div",J,[t[3]||(t[3]=i("label",{for:"message"},"Message",-1)),p(u,{id:"message",modelValue:k(e),"onUpdate:modelValue":t[1]||(t[1]=f=>z(e)?e.value=f:null),"aria-describedby":"message-help"},null,8,["modelValue"]),p(d,{size:"small",severity:"secondary",variant:"simple",class:"mt-4"},{default:S(()=>[l(r.$slots,"default")]),_:3})]),p(b,{type:"submit",icon:"pi pi-send",size:"large",label:"Submit",iconPos:"right",class:"fade-in"})],32)}}}),se=Object.assign(Q,{__name:"Contact"});export{se as default};
